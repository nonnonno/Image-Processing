                ...
                if(b<i && i < (height1+b) && a< j &&j < (width1+a)) {
                    ...
                    if(color0.getRed() > 0) {
						...
						Color color1 = input1.getColor(j-a, i-b);
						 Color color2 = input2.getColor(j-450, i);//移動先の画素値を持ってくる
						...
						output.setColor(width-j-700, i, color3);//反転してくれる
						isProcessed = true;
						}   
                        else{
                            Color color1 = input1.getColor(width-j,i);
